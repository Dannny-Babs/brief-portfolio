...
// Placeholder for missing SOCIAL_LINKS
const SOCIAL_LINKS = [
    { title: "GitHub", href: "https://github.com", icon: "/github.svg" },
    { title: "Twitter", href: "https://twitter.com", icon: "/twitter.svg" },
];

// Placeholder for missing Icons.react
const Icons = { react: TriangleDashedIcon };

// Placeholder for missing Post type
// type Post = any;

// Placeholder for missing ChanhDaiMark
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ChanhDaiMark = (props: any) => <span {...props}>Logo</span>;

// Dummy posts for demonstration
const dummyPosts: CommandLinkItem[] = [];
...
export function CommandMenu(/*{ posts }: { posts: Post[] }*/) {
    ...
    const { blogLinks, componentLinks } = useMemo(
        () => ({
            blogLinks: dummyPosts,
            componentLinks: dummyPosts,
        }),
        []
    );
