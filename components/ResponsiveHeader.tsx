    ...
    return (
        <header className="max-w-5xl w-full sticky top-0 z-10 border-r-[1.5px] border-l-[1.5px] border-b-[1.5px] border-dark-border mx-auto p-4 flex items-center justify-between bg-dark-background">
            ...
            <div className="flex items-center gap-2">
                <Link href="/" className="rounded-sm shrink-0">
                    <Image
                        src="/images/logo.png"
                        alt="Daniel Babalola home"
                        width={50}
                        height={50}
            ...
            <div className="hidden md:flex items-center gap-4">
                <Link href="https://github.com/Dannny-Babs" className="rounded-full">
                ...
                <Link href="https://x.com/kng_lax" className="rounded-full">
                    <div className="flex items-center justify-center p-2 rounded-full border-[1.5px] border-dark-border">
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                    <DialogTrigger asChild>
                        <button
                            type="button"
                            className="w-8 h-8 flex items-center justify-center rounded-md bg-nav-link/10 ml-2"
                        >
                    ...
                    <DialogContent className="p-0 bg-dark-background border-none max-w-xs w-full">
                        <nav className="flex flex-col gap-4 p-6" aria-label="Site">
                            <Link href="/about" className="text-nav-link text-lg font-semibold rounded-sm">
                                About
                            </Link>
                            <Link href="/blog" className="text-nav-link text-lg font-semibold rounded-sm">
                                Blog
                            </Link>
                            <Link href="/gallery" className="text-nav-link text-lg font-semibold rounded-sm">
                                Gallery
                            </Link>
            ...
            <div className="md:hidden">
                <Dialog open={open} onOpenChange={setOpen}>
                    <DialogTrigger asChild className="text-nav-link">
                        <button
                            type="button"
                            className="w-8 h-8 flex items-center justify-center rounded-md bg-nav-link/10"
                        >
                            <span className="sr-only">Open navigation</span>
                            <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-nav-link"><line x1="3" y1="12" x2="21" y2="12" /><line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="18" x2="21" y2="18" /></svg>
                        </button>
