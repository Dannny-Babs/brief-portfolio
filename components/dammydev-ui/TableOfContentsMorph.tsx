...
export default function TableOfContentsMorph({}: TableOfContentsProps) {
  ...
  if (!isClient || tocItems.length === 0) return null;
              ...
              {tocItems.map((item, index) => (
                ...
                >
                  <motion.button
                    ...
                    className={`flex flex-row align-left text-left space-y-2 gap-2 ${
                      activeId === item.id ? "text-white" : "text-neutral-400"
      ...
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <h3 className={styles.activeSection}>
            {tocItems.find((item) => item.id === activeId)?.title ||
              "Table of Contents"}
          </h3>
